export default {
    accounts: {
      ...
      bulkActions: {
        ...
        batchTesting: 'Testing {processed} / {total}',
        batchTestCompleted: 'Batch test completed: {count} succeeded',
        batchTestCompletedWithFailures: 'Batch test completed: {success} succeeded, {failed} failed',
        batchTestStartFailed: 'Failed to start batch test',
        batchTestInterrupted: 'Progress polling stopped; the task may still be running in the background',
