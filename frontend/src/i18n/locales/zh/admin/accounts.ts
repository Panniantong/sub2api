export default {
    accounts: {
      ...
      bulkActions: {
        ...
        refreshToken: '批量刷新令牌',
        batchTest: '批量测试',
        batchTesting: '测试中 {processed} / {total}',
        batchTestCompleted: '批量测试完成：成功 {count} 个',
        batchTestCompletedWithFailures: '批量测试完成：成功 {success} 个，失败 {failed} 个',
        batchTestStartFailed: '批量测试启动失败',
        batchTestInterrupted: '进度查询中断，任务可能仍在后台运行',
