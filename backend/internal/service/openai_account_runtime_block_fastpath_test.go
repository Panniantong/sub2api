...
func TestOpenAI429FastPath_ExplicitRetryAfterWaitsBeforeScheduling(t *testing.T) {
	repo := &oauth429RateLimitRepo{}
	...
	svc.handleOpenAIAccountUpstreamError(context.Background(), a, 429, headers, body)
